...
public class XmlConstants {
    ...
    public static final String IBATOR_CONFIG_PUBLIC_ID =
            "-//Apache Software Foundation//DTD Apache iBATIS Ibator ConfigurationParam 1.0//EN"; //$NON-NLS-1$

    public static final String MYBATIS_GENERATOR_CONFIG_SYSTEM_ID =
            "http://mybatis.org/dtd/mybatis-org.mybatis.generator-config_1_0.dtd"; //$NON-NLS-1$

    public static final String MYBATIS_GENERATOR_CONFIG_PUBLIC_ID =
            "-//mybatis.org//DTD MyBatis Generator ConfigurationParam 1.0//EN"; //$NON-NLS-1$
}
