...
public class VirtualPrimaryKeyPlugin extends PluginAdapter {
    ...
    /* (non-Javadoc)
     * @see org.mybatis.org.mybatis.generator.api.Plugin#validate(java.util.List)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.mybatis.org.mybatis.generator.api.PluginAdapter#initialized(org.mybatis.org.mybatis.generator.api.IntrospectedTable)
     */
    @Override
